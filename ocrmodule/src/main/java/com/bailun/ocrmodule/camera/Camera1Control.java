...
import com.bailun.ocrmodule.camera.interfaces.PermissionCallback;
...
public class Camera1Control implements ICameraControl {
    ...
    @Override
    public void setDisplayOrientation(@Orientation int displayOrientation) {
        ...
        switch (displayOrientation) {
            ...
            case Orientation.ORIENTATION_HORIZONTAL:
                rotation = 0;
                break;
            case Orientation.ORIENTATION_INVERT:
                rotation = 180;
                break;
            default:
                rotation = 0;
